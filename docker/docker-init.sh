...
echo_step "5" "Starting" "Importing the Pinot storm datasource"
superset import-datasources --path ./pinot-database.yml
echo_step "5" "Complete" "Importing the Pinot storm datasource"

# Import Pinot dashboards
echo_step "6" "Starting" "Importing the Pinot storm dashboard"
superset import-dashboards --path ./pinot-dashboard.json
echo_step "6" "Complete" "Importing the Pinot storm dashboard"
